...
namespace HD.Configuration.Binder
{
    /// <summary>
    ...
    public static class ConfigurationBinder
    {
        ...
        private static object CreateInstance(Type type)
        {
            ...
            {
                throw new InvalidOperationException(string.Format("FormatError_CannotActivateAbstractOrInterface({0})", type.Name));
            }
            ...
            if (type.IsArray)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format("FormatError_UnsupportedMultidimensionalArray({0})", type.Name));
                }
            ...
            {
                throw new InvalidOperationException(string.Format("FormatError_MissingParameterlessConstructor({0})", type.Name));
            }
            ...
            {
                throw new InvalidOperationException(string.Format("FormatError_FailedToActivate({0})", type.Name), ex);
            }
        }
        ...
        private static object ConvertValue(Type type, string value)
        {
            ...
            {
                throw new InvalidOperationException(string.Format("FormatError_FailedBinding({0})", type.Name), ex);
            }
        }
